...
class Command(BaseCommand):
    ...
    def get_weather_data(self):
        ...
        url = "https://api.open-meteo.com/v1/forecast?latitude=40.8&longitude=-74&hourly=temperature_2m,relativehumidity_2m,dewpoint_2m,apparent_temperature,precipitation_probability,rain,snowfall,weathercode,cloudcover,windspeed_10m&forecast_days=1"
